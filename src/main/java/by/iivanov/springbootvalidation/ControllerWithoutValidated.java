...
@RestController
@RequestMapping("/without-validated")
class ControllerWithoutValidated {

    private static final Logger log = org.slf4j.LoggerFactory.getLogger(ControllerWithoutValidated.class);
