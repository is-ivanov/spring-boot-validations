...
@Service
@Validated
public class ServiceAsInterfaceWithImpl implements ServiceAsInterfaceWith {

    private static final Logger log = LoggerFactory.getLogger(ServiceAsInterfaceWithImpl.class);
